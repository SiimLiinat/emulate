...
{
    /// <summary>
    /// PageModel for LoginWithRecoveryCode
    /// </summary>
    [AllowAnonymous]
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        /// <summary>
        /// Constructor for LoginWithRecoveryCode PageModel
        /// </summary>
        ...
        /// <summary>
        /// Gets recovery code login page while ensuring the user has gone through the username and password screen first.
        /// </summary>
        /// <param name="returnUrl">Return URL</param>
        /// <returns>Recovery code login page</returns>
        ...
        /// <summary>
        /// Logs in user using recovery code.
        /// </summary>
        /// <param name="returnUrl">Return URL</param>
