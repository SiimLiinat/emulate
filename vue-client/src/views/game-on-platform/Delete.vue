<template>
    <div class="card card-body mt-5">
        <div v-if="!loading" class="card card-body">
            ...
            <div>
                <input @click="deleteGameOnPlatform" type="submit" value="Delete" class="btn btn-danger" />
            </div>
        </div>
        <div v-if="!loading">
...
export default class GameOnPlatformDelete extends Vue {
    id!: string;
    ...
    async deleteGameOnPlatform(): Promise<void> {
        const service = new BaseService<IGameOnPlatform>('v1/gameOnPlatforms', this.token || undefined);
